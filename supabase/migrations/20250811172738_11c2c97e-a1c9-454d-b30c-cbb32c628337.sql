...
-- Policies
CREATE POLICY IF NOT EXISTS "Anyone can view post reports"
ON public.post_reports
FOR SELECT
USING (true);

CREATE POLICY IF NOT EXISTS "Users can create their own post reports"
ON public.post_reports
FOR INSERT
WITH CHECK (auth.uid() = user_id);

CREATE POLICY IF NOT EXISTS "Users can delete their own post reports"
ON public.post_reports
FOR DELETE
